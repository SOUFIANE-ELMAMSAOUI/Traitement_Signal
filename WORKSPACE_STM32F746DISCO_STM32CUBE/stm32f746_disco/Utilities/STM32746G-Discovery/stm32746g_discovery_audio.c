...
static void SAIx_In_Init(uint32_t SaiOutMode, uint32_t SlotActive, uint32_t AudioFreq)
{
  ...
  haudio_out_sai.Init.FIFOThreshold = SAI_FIFOTHRESHOLD_3QF;//SAI_FIFOTHRESHOLD_1QF;
  ...
  haudio_in_sai.Init.FIFOThreshold = SAI_FIFOTHRESHOLD_3QF;//SAI_FIFOTHRESHOLD_1QF;
...
static void SAIx_In_Init_SAIinterrupt(uint32_t SaiOutMode, uint32_t SlotActive, uint32_t AudioFreq)
{
  ...
  haudio_out_sai.Init.Synchro = SAI_ASYNCHRONOUS;
  haudio_out_sai.Init.OutputDrive = SAI_OUTPUTDRIVE_ENABLED;
  haudio_out_sai.Init.FIFOThreshold = SAI_FIFOTHRESHOLD_3QF;//SAI_FIFOTHRESHOLD_EMPTY; // can we try empty later on? was 1QF
  ...
  haudio_in_sai.Init.Synchro = SAI_SYNCHRONOUS;
  haudio_in_sai.Init.OutputDrive = SAI_OUTPUTDRIVE_DISABLED;
  haudio_in_sai.Init.FIFOThreshold =  SAI_FIFOTHRESHOLD_3QF;//SAI_FIFOTHRESHOLD_EMPTY;
